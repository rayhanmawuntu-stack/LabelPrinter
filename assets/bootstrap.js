(async()=>{
  try{
    const version='20260710-analytics-hover-tooltips-22';
    ...
    for(const href of ['assets/style-03b.css','assets/style-05b.css','assets/style-06.css','assets/style-07.css','assets/style-08.css','assets/style-09.css','assets/style-10.css','assets/style-11.css','assets/style-12.css','assets/style-13.css','assets/style-14.css','assets/style-15.css','assets/style-16.css','assets/style-17.css','assets/style-18.css','assets/style-19.css','assets/style-20.css','assets/style-21.css','assets/style-22.css','assets/style-23.css','assets/style-24.css','assets/style-25.css','assets/style-26.css','assets/style-27.css','assets/style-28.css']){const link=document.createElement('link');link.rel='stylesheet';link.href=`${href}?v=${version}`;document.head.appendChild(link)}
    ...
    const scripts=['assets/app-favicon.js','assets/no-mock.js','assets/app-01.js','assets/app-theme.js','assets/app-02.js','assets/app-03.js','assets/app-03b.js','assets/app-04.js','assets/app-04b.js','assets/app-analytics-hover.js','assets/app-import.js','assets/app-pdf.js','assets/app-05.js'];
