...
function setStatus(state,text){connected=state==='connected';const s=$('status'),label=$('statusText');if(s)s.dataset.state=state;if(label)label.textContent=text}
